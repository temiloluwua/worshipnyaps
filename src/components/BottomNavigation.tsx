...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({
  ...
  const tabs = [
    { id: 'topics' as const, nameKey: 'nav.topics', icon: MessageSquare },
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 px-4 pt-2 transition-colors"
